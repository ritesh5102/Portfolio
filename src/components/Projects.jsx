...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: 'Smart Farm',
      description: 'AI-based agriculture project for crop monitoring, disease detection, and yield optimization.',
      techStack: ['Python', 'Machine Learning', 'IoT', 'TensorFlow'],
      github: 'https://github.com/ritesh5102/Smart-Farm',
      category: 'ai'
    },
    {
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-lg font-semibold hover:opacity-90 transform hover:scale-105 transition-all duration-300"
              >
